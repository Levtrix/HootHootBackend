...
public class BroedparenBerekenenTest {
    ...
    public void TestBerekenAantalBroedparen() {
        ...
        waarnemingen.add(new Waarneming(1, datumWaarneming1, vogel1, SoortWaarneming.NestIndicerend, 50, 50));
        waarnemingen.add(new Waarneming(2, datumWaarneming1, vogel1, SoortWaarneming.TerritoriumIndicerend, 50, 50));
        waarnemingen.add(new Waarneming(3, datumWaarneming1, vogel2, SoortWaarneming.VogelAanwezig, 50, 50));
        waarnemingen.add(new Waarneming(4, datumWaarneming1, vogel1, SoortWaarneming.VogelAanwezig, 50, 50));
        waarnemingen.add(new Waarneming(5, datumWaarneming1, vogel2, SoortWaarneming.VogelAanwezig,50, 50));
    ...
    public void TestAfrondingBerekenAantalBroedparen() {
        ...
        List<Waarneming> waarnemingen = new ArrayList<>();
        waarnemingen.add(new Waarneming(1, datumWaarneming, vogel2, SoortWaarneming.NestIndicerend, 50, 50));
        waarnemingen.add(new Waarneming(2, datumWaarneming, vogel1, SoortWaarneming.TerritoriumIndicerend, 50, 50));
        waarnemingen.add(new Waarneming(3, datumWaarneming, vogel2, SoortWaarneming.VogelAanwezig, 50, 50));
        waarnemingen.add(new Waarneming(4, datumWaarneming, vogel2, SoortWaarneming.VogelAanwezig, 50, 50));
        waarnemingen.add(new Waarneming(5, datumWaarneming, vogel2, SoortWaarneming.VogelAanwezig, 50, 50));
    ...
    public void TestBerekenAantalBroedparenBuitenBroedperiode() {
        ...
        waarnemingen.add(new Waarneming(2, datumWaarneming, vogel1, SoortWaarneming.TerritoriumIndicerend, 50, 50));
        waarnemingen.add(new Waarneming(3, datumWaarneming, vogel2, SoortWaarneming.VogelAanwezig, 50, 50));
        waarnemingen.add(new Waarneming(4, datumWaarneming, vogel1, SoortWaarneming.VogelAanwezig, 50, 50));
        waarnemingen.add(new Waarneming(5, datumWaarneming, vogel2, SoortWaarneming.VogelAanwezig, 50, 50));
        telgebied.addBezoek(new Bezoek(1, datumWaarneming, datumWaarneming, telgebied, vogelteller, waarnemingen));
    ...
    public void TestBerekenAantalBroedparenMetGeenWaarnemingen() {
        Date datumWaarneming = new GregorianCalendar(2019, Calendar.APRIL, 23).getTime();
        List<Waarneming> waarnemingen = new ArrayList<>();
        waarnemingen.add(new Waarneming(1, datumWaarneming, vogel1, SoortWaarneming.NestIndicerend, 50, 50));
        waarnemingen.add(new Waarneming(2, datumWaarneming, vogel1, SoortWaarneming.TerritoriumIndicerend, 50, 50));
        waarnemingen.add(new Waarneming(3, datumWaarneming, vogel1, SoortWaarneming.VogelAanwezig, 50, 50));
        waarnemingen.add(new Waarneming(4, datumWaarneming, vogel1, SoortWaarneming.VogelAanwezig, 50, 50));
        waarnemingen.add(new Waarneming(5, datumWaarneming, vogel1, SoortWaarneming.VogelAanwezig, 50, 50));
        telgebied.addBezoek(new Bezoek(1, datumWaarneming, datumWaarneming, telgebied, vogelteller, waarnemingen));
